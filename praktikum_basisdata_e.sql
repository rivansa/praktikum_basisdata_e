...
-- Dumping database structure for praktikum_basisdata_e
CREATE DATABASE IF NOT EXISTS `praktikum_basisdata_e` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `praktikum_basisdata_e`;

-- Dumping structure for table praktikum_basisdata_e.bagian
...
-- Dumping data for table praktikum_basisdata_e.bagian: ~3 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.bagian_karyawan
...
-- Dumping data for table praktikum_basisdata_e.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.jabatan
...
-- Dumping data for table praktikum_basisdata_e.jabatan: ~5 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.jabatan_karyawan
...
-- Dumping data for table praktikum_basisdata_e.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.karyawan
...
-- Dumping data for table praktikum_basisdata_e.karyawan: ~8 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.lokasi
...
-- Dumping data for table praktikum_basisdata_e.lokasi: ~3 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.penggajian
...
-- Dumping data for table praktikum_basisdata_e.penggajian: ~18 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.pengguna
...
-- Dumping data for table praktikum_basisdata_e.pengguna: ~8 rows (approximately)
...
-- Dumping structure for table praktikum_basisdata_e.presensi
...
-- Dumping data for table praktikum_basisdata_e.presensi: ~552 rows (approximately)
